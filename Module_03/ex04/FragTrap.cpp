...
/*   Updated: 2021/03/24 16:06:25 by mhaman           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap():ClapTrap(100,100,100,100,1,0,30,20,5){}
...
FragTrap::FragTrap(std::string name):ClapTrap(100,100,100,100,1,name,30,20,5)
{
	...
	std::cout << "Hello Je suis " << name << " Droide de combat level " << this->_level << " Pour vous servir !\n" << std::endl;
}
