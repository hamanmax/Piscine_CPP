...
/*   Updated: 2021/03/23 12:00:21 by mhaman           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
_age(get_age), _height(get_height), _weight(get_weight), _name(get_name), _color(get_color)
{
...
{
	std::cout << "NAME:\t" << _name << std::endl  << "COLOR:\t" << _color << std::endl << "AGE:\t" << _age << " ans" << std::endl << "HEIGHT:\t" << _height << " cm" << std::endl << "WEIGHT:\t" << _weight << " kg" << std::endl;
}
