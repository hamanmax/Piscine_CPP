...
/*   Updated: 2021/03/15 17:55:34 by mhaman           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void Contact::print_contact(void)
{
	...
	std::cout << "LOGIN\t\t\t:" << first_name << std::endl;
	std::cout << "POSTAL ADDRESS\t\t:" << first_name << std::endl;
	std::cout << "EMAIL ADDRESS\t\t:" << first_name << std::endl;
